...
export default function AuthScreen() {
  ...
  const [verificationCode , setVerifactionCode] = useState("");
  const [loading , setLoading] = useState(false);
  const [verifying , setVerifying] = useState(false);
  const [verifyingMode , setVerifyingMode] = useState<"login" | "login-mfa" | "register" >("register");
